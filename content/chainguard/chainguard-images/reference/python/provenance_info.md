...
| `cgr.dev/chainguard-private` | 3, 3-dev, 3.10-dev, 3.10.14-dev, 3.11-dev, 3.11.9-dev, 3.12, 3.12-dev, 3.12.4, 3.12.4-dev, 3.8-dev, 3.8.19-dev, 3.9-dev, 3.9.19-dev, latest, latest-dev |
