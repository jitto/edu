---
title: "qdrant Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public qdrant Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/qdrant/image_specs/" >}}
...
This page shows detailed information about the Chainguard **qdrant** Image.

|              | latest-dev                      |
|--------------|---------------------------------|
| Default User | `root`                          |
| Entrypoint   | `/usr/lib/qdrant/entrypoint.sh` |
| CMD          | not specified                   |
| Workdir      | `/qdrant`                       |
| Has apk?     | yes                             |
| Has a shell? | yes                             |
